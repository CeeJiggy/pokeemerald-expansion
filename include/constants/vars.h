...
#define VAR_REPEL_LAST_USED 0x404E // Repels
...
#define VAR_DEX_FILL_ASK 0x4061   // Has Birch's aide asked if you want to fill dex seend data
...
#define VAR_OPPOSITE_SHINY 0x40DB // Unused Var
