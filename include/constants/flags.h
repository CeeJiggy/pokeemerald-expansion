...
#define FLAG_RECEIVED_BOX_LINK 0x110
...
#define FLAG_POKEMONPCMENU 0x1DA // Unused Flag
...
#define FLAG_ITEM_MAGMA_HIDEOUT_3F_3R_CALCIUM 0x423
...
#define FLAG_ITEM_NEW_MAUVILLE_MAGNET 0x434
...
#define FLAG_ITEM_ABANDONED_SHIP_ROOMS_B1F_NUGGET 0x448
...
#define FLAG_SYS_BOXLINK_GET 0x493 // Recieved the box link
#define FLAG_PRES_CALL_BOX 0x494   // Unused Flag
...
#define FLAG_SEEN_DATA (SYSTEM_FLAGS + 0x85)     // Unused Flag
#define FLAG_GOT_AXE (SYSTEM_FLAGS + 0x86)       // Unused Flag
#define FLAG_STAT_TUTORIAL (SYSTEM_FLAGS + 0x87) // Stat Editor tutorial finished
#define FLAG_UNLOCK_SHINY (SYSTEM_FLAGS + 0x88)  // Unused Flag
