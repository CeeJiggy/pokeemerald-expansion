...
// #if B_EXP_CAP_TYPE != EXP_CAP_NONE && B_EXP_CAP_TYPE != EXP_CAP_HARD && B_EXP_CAP_TYPE != EXP_CAP_SOFT && B_EXP_CAP_TYPE != VAR_LEVEL_CAP_TYPE
// #error "Invalid choice for B_EXP_CAP_TYPE, must be of [EXP_CAP_NONE, EXP_CAP_HARD, EXP_CAP_SOFT]"
// #endif

// #if B_EXP_CAP_TYPE == EXP_CAP_HARD || B_EXP_CAP_TYPE == EXP_CAP_SOFT || B_EXP_CAP_TYPE == 0 || B_EXP_CAP_TYPE == 1
// #if B_LEVEL_CAP_TYPE != LEVEL_CAP_FLAG_LIST && B_LEVEL_CAP_TYPE != LEVEL_CAP_VARIABLE && B_LEVEL_CAP_TYPE != VAR_LEVEL_CAP_TYPE
