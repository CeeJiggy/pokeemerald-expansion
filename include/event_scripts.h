...
extern const u8 EventScript_UseStrengthItem[];
...
extern const u8 EventScript_TurnOffPCLink[];
extern const u8 EventScript_TestSignpostMsg[];
...
extern const u8 EventScript_UseWaterfallSkip[];
extern const u8 EventScript_CannotUseWaterfall[];
extern const u8 EventScript_DiveSpot[];
extern const u8 EventScript_UseDive[];
extern const u8 EventScript_CheckScuba[];
extern const u8 EventScript_CheckScubaUnder[];
extern const u8 EventScript_UseDiveSkip[];
extern const u8 EventScript_UseDiveItem[];
extern const u8 EventScript_UseDiveUnderItem[];
extern const u8 EventScript_UseDiveUnderSkip[];
