...
// void ItemMenu_RegisterList(u8 taskId);
// u8 Register_GetItemListPosition(u16 itemId);
// void ItemMenu_FailRegister(u8 taskId);
// void Task_ScrollingMultichoiceInput(u8 taskId);
//  bool8 Register_IsItemInList(u16 itemId);
