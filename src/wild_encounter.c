...
u8 PickWildMonNature(void)
{
    ...
    if (OW_SYNCHRONIZE_NATURE < GEN_9 && !GetMonData(&gPlayerParty[0], MON_DATA_SANITY_IS_EGG) && GetMonAbility(&gPlayerParty[0]) == ABILITY_SYNCHRONIZE && (OW_SYNCHRONIZE_NATURE == GEN_8 || Random() % 2 == 0))
    {
