...
static void MoveSelectionDisplayMoveNames(u32 battler)
{
    ...
    for (i = 0; i < MAX_MON_MOVES; i++)
    {
        ...
        if ((gBattleStruct->dynamax.playerSelect && CanDynamax(battler)) || IsDynamaxed(battler))
