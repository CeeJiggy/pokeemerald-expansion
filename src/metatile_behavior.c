...
static const u8 sTileBitAttributes[NUM_METATILE_BEHAVIORS] =
{
    ...
    [MB_FORTREE_BRIDGE_START]               = TILE_FLAG_UNUSED,
...
bool8 MetatileBehavior_IsFortreeBridgeStart(u8 metatileBehavior)
{
    if (metatileBehavior == MB_FORTREE_BRIDGE_START)
        return TRUE;
    else
        return FALSE;
}
...
{
    if (metatileBehavior == MB_NO_RUNNING || metatileBehavior == MB_HOT_SPRINGS //|| metatileBehavior == MB_LONG_GRASS
