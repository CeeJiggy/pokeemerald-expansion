...
const u8 gText_CantUseItemYet[] = _("You don't have the badge required to\nuse this yet!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PokenavAndBag[] = ("PokéNav and Bag");
...
const u8 gText_SeeYaDescription[] = _("Exit the Pokémon Storage System.");
...
const u8 gText_PutAwayPokenav[] = ("Put away the PokéNav.");
...
const u8 gText_ReturnToPokenavMenu[] = ("Return to the PokéNav menu.");
...
const u8 gText_HMShow[] = _("Show");
const u8 gText_HMSkip[] = _("Skip");
const u8 gText_HealNormal[] = _("Normal");
const u8 gText_HealFast[] = _("Fast");
const u8 gText_8192[] = _("Normal");
const u8 gText_Reverse[] = _("Reverse");
